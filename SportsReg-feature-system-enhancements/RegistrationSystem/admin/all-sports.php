    ...
    <?php
      ...
      <tr>
        ...
        echo '<td>'.$i.'</td>
          ...
          <td>
            <a class="btn btn-xs btn-warning" href="index.php?page=edit-sport&id='.base64_encode($result['id']).'">
              <i class="fa fa-edit"></i></a>

             &nbsp; <a class="btn btn-xs btn-danger" onclick="javascript:confirmationDelete($(this));return false;" href="index.php?page=delete-sport&id='.base64_encode($result['id']).'">
