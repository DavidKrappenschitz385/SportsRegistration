    ...
    <?php
      ...
      <tr>
        ...
        echo '<td>'.$i.'</td>
          ...
          <td>
            <a class="btn btn-xs btn-warning" href="index.php?page=edit-player&id='.base64_encode($result['id']).'&photo='.base64_encode($result['photo']).'">
              <i class="fa fa-edit"></i></a>
            &nbsp;
            <a class="btn btn-xs btn-danger" onclick="javascript:confirmationDelete($(this));return false;" href="index.php?page=delete-player&id='.base64_encode($result['id']).'&photo='.base64_encode($result['photo']).'">
             <i class="fas fa-trash-alt"></i>
            </a>
            &nbsp;
            <a class="btn btn-xs btn-info" href="index.php?page=generate-id&id='.base64_encode($result['id']).'" target="_blank">
